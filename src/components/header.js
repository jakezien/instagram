          ...
          >
            <h1 className="">
              <Link
                ...
                className="w-6/12"
              >
                <div className="mt-2 ml-1 w-full max-h-9 md:max-h-8">
                  <svg
                    width="100%"
                    height="100%"
                    viewBox="0 0 2132 533"
            ...
            {user ? (
              <>
                {user.isAdmin && (
                  ...
                  >
                    <div className="cursor-pointer hover:bg-yellow-200 p-2 rounded-md dark:text-gray-300 dark:hover:bg-yellow-900">
                      Add photo
                    </div>
                  </Link>
                )}
                ...
                <div className="flex items-center cursor-pointer">
                            ...
                            <>
                              <div className="flex flex-row">
                                ...
                                <button
                                  ...
                                  className="px-2 py-2 rounded-md hover:bg-yellow-200 dark:text-gray-300 dark:hover:bg-yellow-900"
                                >
                                  Edit your username
                                </button>
                              </div>
                  ...
                  >
                    <div
                      ...
                      className='cursor-pointer hover:bg-yellow-200 p-2 rounded-md dark:text-gray-300 dark:hover:bg-yellow-900'
                    >
